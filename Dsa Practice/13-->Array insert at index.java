...
https://www.geeksforgeeks.org/problems/array-insert-at-index/1?page=2&category=Arrays&difficulty=Basic&status=solved,unsolved&sortBy=submissions

Ans-->
class Solution
{
   public void InsertAtIndex(int arr[],int sizeOfArray,int index.inr element)
  {
